...
#   INPUT VARIBLES: ell, Mx1 vector of LD scores; z.1, Mx1 vector of
#   estimated marginal per-normalized-genotype effects on trait 1
#   (or Z scores; invariant to scaling); z.2, Mx2 vector of effects on trait
#   2; crosstrait.intercept, 0 if cohorts are disjoint or overlap is known, 1 if cohorts are
#   possibly nondisjoint and necessary correction is unknown
...
#   n2, sample size for trait 2; noisecorr,
...
#   we recommend only reporting results for h2.zscore.k > 7 (a very stringent threshold).
